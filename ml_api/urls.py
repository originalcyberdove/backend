...
urlpatterns = [
    ...
    path('predict/',       views.predict_sms,   name='predict_sms'),
    ...
    path('admin/flag/',     views.admin_flag_number,   name='admin_flag'),
    path('admin/unflag/',   views.admin_unflag_number, name='admin_unflag'),
]